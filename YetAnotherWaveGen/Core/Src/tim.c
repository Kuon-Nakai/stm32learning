...
void MX_TIM1_Init(void)
{
  ...
  if (HAL_TIMEx_TISelection(&htim1, TIM_TIM1_TI1_COMP2, TIM_CHANNEL_1) != HAL_OK)
  {
    Error_Handler();
  }
...
void MX_TIM4_Init(void)
{
  ...
  if (HAL_TIMEx_TISelection(&htim4, TIM_TIM4_TI1_COMP1, TIM_CHANNEL_1) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    /* TIM1 DMA Init */
    /* TIM1_CH1 Init */
    hdma_tim1_ch1.Instance = DMA1_Channel6;
    ...
    /* TIM1_CH2 Init */
    hdma_tim1_ch2.Instance = DMA2_Channel6;
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    /* TIM4 DMA Init */
    /* TIM4_CH1 Init */
    hdma_tim4_ch1.Instance = DMA2_Channel4;
  ...
  /* USER CODE END TIM8_MspInit 0 */
    ...
    PA15     ------> TIM8_CH1
    */
    GPIO_InitStruct.Pin = FREQ_INA15_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM8;
    HAL_GPIO_Init(FREQ_INA15_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM15_MspInit 0 */
    ...
    PB14     ------> TIM15_CH1
    */
    GPIO_InitStruct.Pin = TIM15_CH1___J9_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM15;
    HAL_GPIO_Init(TIM15_CH1___J9_GPIO_Port, &GPIO_InitStruct);

    /* TIM15 DMA Init */
    /* TIM15_CH1 Init */
    hdma_tim15_ch1.Instance = DMA2_Channel1;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PA15     ------> TIM8_CH1
    */
    HAL_GPIO_DeInit(FREQ_INA15_GPIO_Port, FREQ_INA15_Pin);
  ...
  /* USER CODE END TIM15_MspDeInit 0 */
    ...
    PB14     ------> TIM15_CH1
    */
    HAL_GPIO_DeInit(TIM15_CH1___J9_GPIO_Port, TIM15_CH1___J9_Pin);
