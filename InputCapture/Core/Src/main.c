...
int lineNum = 0;
char buf[128] = {0};
//Expected next state of key 0 - PC5 - EXTI5 [9:5]
char key0expState = 0;
/* USER CODE END PV */
...
/**
 * @brief         : Appends a log message to the LCD screen.
...
/**
 * @brief         : EXTI5 [9:5], callback function for pin PC5 - KEY_0.
